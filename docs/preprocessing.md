...
>>> be = xam.preprocessing.BayesianTargetEncoder(columns=['x_0', 'x_1'], min_samples=3, smoothing=2, suffix='')
...
>>> be = xam.preprocessing.KFoldTargetEncoder(columns=['x_0', 'x_1'], suffix='', random_state=42)
>>> be.fit_transform(X, y)
    x_0       x_1
0  0.75  0.428571
1  0.75  0.571429
